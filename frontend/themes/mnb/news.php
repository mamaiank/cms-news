            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="thumbnail thumbnail-newsall">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="pic"><a href="news-detail.php?id="><img src="uploads/news/update_01.jpg" alt=""></a></div>
                            </div>
                            <div class="col-sm-6">
                                <div class="caption">
                                    <div class="time-post mb-icon icon-clock">23 มกราคม 2560</div>
                                    <h1 class="title-name">
                                        <a href="news-detail.php?id=">บลจ.กสิกรไทย เปิดแผนดำเนินงานปี 2560 สานต่อแนวคิด “Simplify Your Investment Life”</a>
                                    </h1>
                                    <div class="desc">
                                        นายวศิน วณิชย์วรนันต์ ประธานกรรมการบริหาร บริษัทหลักทรัพย์จัดการกองทุนกสิกรไทย จำกัด (บลจ. กสิกรไทย) (กลาง) เปิดแผนงานและกลยุทธ์การดำเนินงานประจำปี 2560 ชูคอนเซ็ปต์ “Simplify Your Investment Life” ต่อเนื่อง เพื่อยกระดับความเป็นผู้นำธุรกิจกองทุนต่อไปอีกขั้น <a href="news-detail.php?id=" class="navbar-link">[อ่านต่อ]</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="thumbnail thumbnail-newsall">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="pic"><a href="news-detail.php?id="><img src="uploads/news/NA001.jpg" alt=""></a></div>
                            </div>
                            <div class="col-sm-6">
                                <div class="caption">
                                    <div class="time-post mb-icon icon-clock">23 มกราคม 2560</div>
                                    <h1 class="title-name">
                                        <a href="news-detail.php?id=">บลจ.กรุงศรี เปิดตัวกองทุน KF-GTECH มองกลุ่มอุตสาหกรรมเทคโนโลยีมีโอกาสโตสูง เตรียม IPO 6-15 ก.พ.นี้</a>
                                    </h1>
                                    <div class="desc">
                                        ...
                                        ทั้งนี้ <a href="news-detail.php?id=" class="navbar-link">[อ่านต่อ]</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-4">
                    <?php include("inc-navmenu-news.php"); ?>
