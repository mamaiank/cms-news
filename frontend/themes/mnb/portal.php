    ...
    <div class="pagenavi">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Money & Banking Portal</li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="thumbnail thumbnail-newsall">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="pic"><a href="portal-detail.php?id="><img src="uploads/news/NA001.jpg" alt=""></a></div>
                            </div>
                            <div class="col-sm-6">
                                <div class="caption">
                                    <div class="time-post mb-icon icon-clock">23 มกราคม 2560</div>
                                    <h1 class="title-name">
                                        <a href="portal-detail.php?id=">บลจ.กรุงศรี เปิดตัวกองทุน KF-GTECH มองกลุ่มอุตสาหกรรมเทคโนโลยีมีโอกาสโตสูง เตรียม IPO 6-15 ก.พ.นี้</a>
                                    </h1>
                                    <div class="desc">
                                        ...
                                        ทั้งนี้ <a href="portal-detail.php?id=" class="navbar-link">[อ่านต่อ]</a>
                                    </div>
                                </div>
                            </div>
                        </div>
