...
<html lang="en">
  ...
  <body>
    ...
    <?php $page="investment"; include("inc-header.php"); ?>

    <div class="pagenavi">
        <div class="container">
            <ol class="breadcrumb">
                <li><a href="index.php">หน้าแรก</a></li>
                <li><a href="investment.php">Investment Plan</a></li>
                <li class="active">บลจ.กสิกรไทย เปิดแผนดำเนินงานปี 2560 สานต่อแนวคิด “Simplify Your Investment Life”</li>
            </ol>
        </div>
    </div>
    ...
    <section class="mb-section">
        <div class="container">
            <div class="heding-all" style="margin-bottom: 5px;">
                <div class="title SukhumvitSetBold">Investment Plan</div>
            </div>
