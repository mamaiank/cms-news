...
<?php include(__dir__."/../../themes/mnb/views/layouts/inc-header.php"); ?>
    <div class="pagenavi">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active"><?= $model->news_title ?></li>
            </ol>
        </div>
    </div>
    ...
    <section class="mb-section">
        <div class="container">
            ...
            <div class="title-page"><?= $model->news_title ?></div>
            <div class="row">
                <div class="col-sm-8">
...
<script>window.twttr = (function(d, s, id) {
  ...
  return t;
                    ...
                    <div class="detail-news clearfix">
                        <p class="text-center"><?= Yii::$app->MData->showBackendImage('news',$model->id,$model->news_pic) ?></p>
                        <p><?= $model->news_detail ?></p>
                    </div>
                    <div class="back">
