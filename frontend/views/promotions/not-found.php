        ...
        <div class="banner-size">
            ...
            foreach ($ads as $key => $value) {
                if(($value->level != 7 && $value->level != 2) && ($i == 0)){
                    ?>
            <div class="picture">
                <a href="<?= $value->banner_link != '' ? Url::to(['/site/banner', 'id' => $value->id]) : 'javascript:void(0)' ?>"><?= Yii::$app->MData->showImage($value->banner_pic_file,['class'=>'img-responsive center-block','style'=>'max-height: 250px;']) ?></a>
            </div>
                    <?php
                    $i++;
                }
