...
<meta property="og:title"         content="<?php echo $model->post_title; ?>" />
...
<div class="pagenavi">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li><a href="<?= Url::to(['/news/index', 'id' => $_GET['category']]) ?>"><?= $name ?></a></li>
        ...
        ?>
                            <div class="col-sm-4">
                                <div class="thumbnail thumbnail-related">
                                    ...
                                    <div class="caption">
                                        <div class="time-post mb-icon icon-clock"><span class="updated"><?= Yii::$app->MData->changeFormatDate($value->post_date) ?></span></div>
