...
class PostsSearch extends Posts
{
  public $array_id = null;
    ...
    {
        $query = Posts::find()->where(['post_type'=>'post'])->orderBy(['post_date'=>SORT_DESC]);
...
//var_dump($this->array_id);exit();
        $query->andFilterWhere(['IN', 'ID', $this->array_id])
